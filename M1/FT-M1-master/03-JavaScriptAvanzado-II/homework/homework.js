...
a(5) --> Va a cachr --> 10
  ...
  */
  var cache = {}
  return function (x){
     if (cache.hasOwnProperty(x)) {//devuelve true o false verificando si ya esta en el cache 
     return cache[x];
     }else{
     var resultado = cb(x); 
     cache[x] = resultado; // Crea el par key value en el objeto 
     return resultado;
     }
  }
}

//var cacheFunction() --> invoca la funcion 

// Bind --> método para funciones 
